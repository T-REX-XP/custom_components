"""
Support for Gree A/C through API.

Develpoped and kindly shared by Asaf Biton https://github.com/xTCx
...
- platform: gree
  name: room AC
  host: 192.168.1.49
  mac: 'YO:UR:MA:C_:HE:RE' # (AC_MAC)
  unique_key: 'YourUnigueKeyHere'
  timeout: 10
  min_temp: 16
  max_temp: 30
  target_temp: 20
  temp_sensor: sensor.real_temperature_sensor
